    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                topic_input = st.text_input("Enter the topic of the quiz")
                number_input = st.slider("Enter the number of questions", min_value=1, max_value=10)
                ...
                if submitted:
                    ...
                    generator = QuizGenerator(topic_input, number_input, chroma_creator.db)  # Step 3: Initialize a QuizGenerator class using the topic, number of questrions, and the chroma collection
        ...
        with st.container():
            ...
            with st.form("MCQ"):
                index_question = quiz_manager.get_question_at_index(st.session_state["question_index"])# Step 7: Set index_question using the Quiz Manager method get_question_at_index passing the st.session_state["question_index"]
